...
// The customLabels contain fields that need to be joined together before generating the results sheet
  ...
  // Columns are sorted alpha-numerically by default in the results sheet.
  // This property allows changing the sorting type or the order for the columns
  // Custom order for columns can also be provided
  "outputColumns": {
    // Type of sorting to apply
    "sortType": "ALPHABETICAL",
    // Whether to sort in ascending or descending order
    "sortOrder": "DSC",
    // Provide list of columns if you want custom order
    "customOrder": [
      "Roll",
      "q1",
      "q2",
