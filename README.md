...
| 👩🏿‍💻 **Dev Friendly**  | [Pylinted](http://pylint.pycqa.org/) and [Black formatted](https://github.com/psf/black) code. Also has [a developer community on discord](https://discord.gg/qFv2Vqf).                                                                                                                |

Note: For solving interesting challenges, developers can checkout [**TODOs**](https://github.com/Udayraj123/OMRChecker/wiki/TODOs). See details in [Project Wiki](https://github.com/Udayraj123/OMRChecker/wiki/).
