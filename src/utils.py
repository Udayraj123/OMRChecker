...
## Real helping stats:
# cv2.putText(final_marked,"avg: "+str(["avgBlack: "+str(round(np.mean(blackVals),2)),"avgWhite: "+str(round(np.mean(whiteVals),2))]),(20,50),cv2.FONT_HERSHEY_SIMPLEX, TEXT_SIZE,(50,20,10),4)
# cv2.putText(final_marked,"ext: "+str(["maxBlack: "+str(round(np.max(blackVals),2)),"minW(gray): "+str(round(np.min(whiteVals),2))]),(20,90),cv2.FONT_HERSHEY_SIMPLEX, TEXT_SIZE,(50,20,10),4)
...
# ax.set_xlabel("col")
# thrline=ax.axhline(MIN_STD,color='red',ls='--', linewidth=4)
